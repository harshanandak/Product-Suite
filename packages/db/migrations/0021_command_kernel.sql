...
ALTER TABLE "work_items" ADD COLUMN "last_command_marker" uuid;--> statement-breakpoint
ALTER TABLE "work_items" ADD CONSTRAINT "work_items_version_positive" CHECK ("version" > 0);--> statement-breakpoint
...
ALTER TABLE "command_idempotency" ADD CONSTRAINT "command_idempotency_tenant_fk"
  FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
END
$immutable_triggers$;--> statement-breakpoint

GRANT SELECT, INSERT ON TABLE "command_idempotency" TO product_suite_platform_runtime;--> statement-breakpoint
