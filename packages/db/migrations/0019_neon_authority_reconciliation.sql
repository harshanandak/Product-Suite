...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_events" ADD CONSTRAINT "conversation_events_tenant_conversation_fk" FOREIGN KEY ("tenant_id","conversation_id") REFERENCES "public"."conversations"("tenant_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_events" ADD CONSTRAINT "conversation_events_tenant_actor_fk" FOREIGN KEY ("tenant_id","actor_id") REFERENCES "public"."collaboration_actors"("tenant_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_events" ADD CONSTRAINT "conversation_events_tenant_reply_fk" FOREIGN KEY ("tenant_id","conversation_id","reply_to_event_id") REFERENCES "public"."conversation_events"("tenant_id","conversation_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_events" ADD CONSTRAINT "conversation_events_tenant_target_fk" FOREIGN KEY ("tenant_id","conversation_id","target_event_id") REFERENCES "public"."conversation_events"("tenant_id","conversation_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_memberships" ADD CONSTRAINT "conversation_memberships_tenant_conversation_fk" FOREIGN KEY ("tenant_id","conversation_id") REFERENCES "public"."conversations"("tenant_id","id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_memberships" ADD CONSTRAINT "conversation_memberships_tenant_actor_fk" FOREIGN KEY ("tenant_id","actor_id") REFERENCES "public"."collaboration_actors"("tenant_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversation_memberships" ADD CONSTRAINT "conversation_memberships_tenant_created_by_actor_fk" FOREIGN KEY ("tenant_id","created_by_actor_id") REFERENCES "public"."collaboration_actors"("tenant_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "conversations" ADD CONSTRAINT "conversations_tenant_created_by_actor_fk" FOREIGN KEY ("tenant_id","created_by_actor_id") REFERENCES "public"."collaboration_actors"("tenant_id","id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
BEGIN
  ...
  LOOP
    ...
    IF actual_constraint_kind IS NULL
       ...
       OR (expected_row->>'kind' = 'f' AND (
            coalesce(nullif(split_part(actual_ref_table, '.', 2), ''), actual_ref_table)
              IS DISTINCT FROM split_part(expected_row->>'refTable', '.', 2)
       ...
       OR (expected_row->>'kind' = 'c' AND
           ...
           regexp_replace(lower(replace(expected_row->>'definition',
             format('"%s".', split_part(expected_row->>'table', '.', 2)), '')),
             '[[:space:]"()]', '', 'g')) THEN
  ...
  LOOP
    ...
    IF actual_method IS NULL
       ...
       OR regexp_replace(replace(lower(replace(coalesce(actual_predicate, ''),
            format('"%s".', split_part(expected_row->>'table', '.', 2)), '')), '::text', ''),
            '[[:space:]""]', '', 'g')
          IS DISTINCT FROM regexp_replace(replace(lower(replace(coalesce(expected_row->>'predicate', ''),
            format('"%s".', split_part(expected_row->>'table', '.', 2)), '')), '::text', ''),
            '[[:space:]""]', '', 'g') THEN
