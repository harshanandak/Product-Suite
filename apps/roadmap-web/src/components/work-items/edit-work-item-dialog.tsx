...
import { typedZodResolver } from '@/lib/forms/typed-zod-resolver'
...
export function EditWorkItemDialog({
  ...
  const form = useForm<any>({
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- schema varies by phase at runtime
    resolver: typedZodResolver<any>(schema),
    defaultValues: {
      name: '',
      purpose: '',
