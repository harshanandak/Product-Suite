...
const req = () => new NextRequest('http://localhost/api/work-items/wi-1/children')

describe('GET /api/work-items/[id]/children auth', () => {
  beforeEach(() => {
  ...
  it('returns 404 when the parent work item is not found', async () => {
    getAuthClaims.mockResolvedValue(claims)
