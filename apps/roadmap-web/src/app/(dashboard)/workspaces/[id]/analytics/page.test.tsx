...
describe('AnalyticsPage auth', () => {
  ...
  it('redirects to /login when there are no canonical claims', async () => {
    ...
    await expect(AnalyticsPage({ params })).rejects.toThrow('REDIRECT:/login')
  ...
  it('calls notFound when the workspace does not exist', async () => {
    ...
    await expect(AnalyticsPage({ params })).rejects.toThrow('NOTFOUND')
  ...
  it('redirects to /dashboard when the claims subject lacks team access', async () => {
    ...
    await expect(AnalyticsPage({ params })).rejects.toThrow('REDIRECT:/dashboard')
  ...
  it('renders for an authorized member without redirecting', async () => {
    ...
    const result = await AnalyticsPage({ params })
