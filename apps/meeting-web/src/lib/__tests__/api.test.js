...
describe("api runtime config bootstrap", () => {
  ...
  test("delegates rewired meeting API helpers to the SDK client without changing arguments", async () => {
    ...
    const helperCases = [
      ...
      ["getMeetingStateCurrent", ["meeting-123"]],
      ["getChapters", ["meeting-123"]],
      ["getDecisions", ["meeting-123"]],
      ["getActionItems", ["meeting-123"]],
      ["getOpenQuestions", ["meeting-123"]],
      ["getRecentLines", ["meeting-123"]],
      ["queryBuddy", ["meeting-123", { message: "what did we decide?" }]],
      ["searchHistory", ["meeting-123", "roadmap"]],
