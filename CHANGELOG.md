...
- DB Contract now runs deterministic changed-surface cheap gates before protected exact-head Neon evidence, and Base Freshness verifies the current base branch is an ancestor of the reviewed PR head (Forge issue `532329e0-7595-40c2-b939-a3a0735f8071`)
