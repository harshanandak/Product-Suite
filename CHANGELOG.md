...
### Security
- Canonical tenant capability context now derives viewer/member/admin/owner authority from active database memberships and guards team, status, and project writes with fail-closed 404/403 behavior (Forge issue `af872dc9-3c53-4f9d-9fc0-3e0bbdf6889f`)
