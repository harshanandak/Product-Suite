...
### Fixed
- Branch-lease concurrency tests now observe persisted waiter registration, recognize signal-terminated workers, and enclose bounded child cleanup in the test deadline under loaded validation runs (PR #187, Forge issue `b6c7f336-8eea-4e07-9321-21d8c8b4501b`)
