...
### Fixed
- Branch-lease concurrency tests now observe persisted waiter registration and clean up child workers deterministically under loaded validation runs (Forge issue `b6c7f336-8eea-4e07-9321-21d8c8b4501b`)
